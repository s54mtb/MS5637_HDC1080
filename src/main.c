...
//		
//		
//		if (Pressure < 100) bat = 0; // keep compiler happy
//	
//}
...
int main(void)
{
  ...
  while (1)
  {
		if (HAL_UART_Receive_IT(&huart2, &aRxBuffer, 1) == HAL_OK) process_rx_char(aRxBuffer);  
  }
...
void MX_USART2_UART_Init(void)
{
  ...
  huart2.Init.BaudRate = SETUP_BAUDRATE;
